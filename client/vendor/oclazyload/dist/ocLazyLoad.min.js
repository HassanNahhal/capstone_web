...
! function () {
            ...
            for (t = 0, i = n.length; i > t; t++)
                if (u = n[t], angular.isArray(u)) {
                    ...
                    if ("invoke" !== u[1]) s && angular.isDefined(l) && l[u[1]].apply(l, u[2]);
                        ...
                        if (angular.isFunction(u[2][0])) f(u[2][0]);
                        else if (angular.isArray(u[2][0]))
                            for (var d = 0, g = u[2][0].length; g > d; d++) angular.isFunction(u[2][0][d]) && f(u[2][0][d])
                    }
                }
        }
    }
            ...
            for (o = n.length - 1; o >= 0; o--)
                if (u = n[o], "string" != typeof u && (u = i(u)), u && -1 === d.indexOf(u)) {
                    ...
                    if (s = angular.module(u), c && (l.push(u), t(e, s.requires, r)), s._runBlocks.length > 0)
                        for (g[u] = []; s._runBlocks.length > 0;) g[u].push(s._runBlocks.shift());
    ...
    function o(e, n) {
        ...
        if (angular.isString(r) && -1 === f[n][a].indexOf(r)) o(r);
        else {
